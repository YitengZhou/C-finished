...
/*20 steps = "8452 1736" (about 15s), 27 steps = "8641752 3" (about 2m 30s)*/
...
{
  static Board a[MAX];
  int parent=0,empty=1;
  Initial(a,string);
  while (strcmp(a[parent].str,"12345678 ")!=0){
    empty = Next_generation(a,parent,empty,Space_position(a[parent].arr));
    parent++;
  }
  Print_Moving(a,parent);
}
